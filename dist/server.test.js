...
describe("GET /", () => {
    it("provides a nod to instructions in the response body", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield supertest_1.default(server_1.default).get("/"); //could be any other HTTP method
...
describe("action routes", () => {
    ...
    describe("GET /digipet/walk", () => {
        test("if the user has a digipet, it responds with a message about the walk", () => __awaiter(void 0, void 0, void 0, function* () {
            // setup: reset digipet
            model_1.setDigipet(model_1.INITIAL_DIGIPET); // simulating hatching Steve: getting rid of the else scenario
...
describe("GET /digipet/ignore", () => {
    test("if user has digipet, it responds with a message about ignoring", () => __awaiter(void 0, void 0, void 0, function* () {
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
    ...
    test("delegate state change to the ignoreDigipet function", () => __awaiter(void 0, void 0, void 0, function* () {
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
        if (jest.isMockFunction(controller_1.ignoreDigipet)) {
